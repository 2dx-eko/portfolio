   ...
   <div class="login_col">
      ...
      <div class="login_ingo">
         <form method="POST">
            ...
            <div class="flex">
               <span class="border">メールアドレスを入力してください</span>
            </div>
            <?php if($_SESSION["sendmail_error"]): ?>
               <div class="flex">
                  <span class="error"><?php echo $_SESSION["sendmail_error"]; ?></span>
               </div>
            <?php endif; ?>
            <div class="flex">
               <p>MAIL</p>
               <input type="text" name="send_mail" value="<?php echo $_POST["send_mail"]; ?>">
               <br>
            </div>
            <div class="flex">
               <button class="btn btn--blue"><i class="far fa-envelope"></i> 送信</button>
            </div>
         </form>
